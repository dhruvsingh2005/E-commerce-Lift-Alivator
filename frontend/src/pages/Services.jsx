...
const Services = () => {
    return (
        <div className="pt-20 sm:pt-24 min-h-screen bg-background-dark">
            <section className="pt-16 sm:pt-24 pb-12 sm:pb-16 px-4 sm:px-6 lg:px-40">
                <div className="max-w-5xl">
                    ...
                    <h1 className="serif-title text-4xl sm:text-6xl md:text-8xl font-light text-white leading-none">
                        Maintenance & <br />
            ...
            <section className="px-4 sm:px-6 lg:px-40 pb-24 sm:pb-48">
            ...
            <section className="px-4 sm:px-6 lg:px-40 bg-obsidian relative py-16 sm:py-40 border-t border-primary/10">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-primary/20 border-y border-primary/20">
                    <div className="bg-background-dark p-6 sm:p-10 hover:shadow-[0_0_15px_rgba(201,167,74,0.15)] hover:border-primary/80 transition-all group border-primary/10 sm:border-r">
                    ...
                    <div className="bg-background-dark p-6 sm:p-10 hover:shadow-[0_0_15px_rgba(201,167,74,0.15)] hover:border-primary/80 transition-all group border-primary/10">
