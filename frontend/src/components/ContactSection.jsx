...
const ContactSection = () => {
  return (
    <section className="py-24 bg-[#163D35] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="flex-1">
            ...
            <h2 className="serif-title text-5xl md:text-6xl text-white mb-8">Let's Discuss Your <br /><span className="text-[#F26522] italic">Vertical Vision.</span></h2>
              ...
              <div className="flex items-start gap-4 lg:col-span-2">
                ...
                <div className="w-full">
                  ...
                  <a
                    ...
                    className="text-white font-medium hover:text-[#F26522] transition-colors"
                  >
          ...
          <div className="flex-1">
            <div className="bg-[#1F2933] border border-white/10 p-8 md:p-12 rounded-sm">
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] uppercase tracking-widest text-white/60 font-bold ml-1">Full Name</label>
                    <input type="text" placeholder="John Doe" className="w-full bg-white/5 border border-white/10 rounded-sm p-4 text-white placeholder-white/60 focus:border-[#F26522] transition-all outline-none" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-[10px] uppercase tracking-widest text-white/60 font-bold ml-1">Email Address</label>
                    <input type="email" placeholder="john@example.com" className="w-full bg-white/5 border border-white/10 rounded-sm p-4 text-white placeholder-white/60 focus:border-[#F26522] transition-all outline-none" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-widest text-white/60 font-bold ml-1">Project Type</label>
                  <select className="project-type-select w-full bg-white/5 text-white border border-white/10 rounded-sm p-4 focus:border-[#F26522] transition-all outline-none appearance-none">
                ...
                <div className="space-y-2">
                  <label className="text-[10px] uppercase tracking-widest text-white/60 font-bold ml-1">Your Message</label>
                  <textarea rows="4" placeholder="How can we help you?" className="w-full bg-white/5 border border-white/10 rounded-sm p-4 text-white placeholder-white/60 focus:border-[#F26522] transition-all outline-none resize-none"></textarea>
                </div>
